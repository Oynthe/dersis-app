...
- Trigger the bug-report button and confirm it opens the default mail client (`mailto:emre.uygun.elt@gmail.com`); confirm the clipboard fallback when no mail client is configured.
