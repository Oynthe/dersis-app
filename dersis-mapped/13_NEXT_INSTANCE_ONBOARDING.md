...
5. To exercise the bug/crash flow, click the status-bar bug icon (or trigger an exception) and confirm your email client opens prefilled to `dersis.app@gmail.com`.
