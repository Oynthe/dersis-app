...
- **Recommendation** Darken in-cell secondary text; render badges as filled pills with white text; raise the open-slots room label to ≥ 4.5:1. **Effort** S · **Related** ST-UI-004, ST-UI-006 · **Status** **Fixed** (Phase 5, branch `fix/phase-5-consistency`)
